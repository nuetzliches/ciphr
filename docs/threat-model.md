...
**Status:** current as of 2026-08-27, `v0.13.2` released, phases 0-3, 7 and 8 in it. The adversaries and boundaries are settled. **A3 gains an optional detection** rather than
