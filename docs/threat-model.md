...
**Status:** current as of 2026-08-25, `v0.12.0` released, phases 0-3, 7 and 8 in it. The adversaries and boundaries are settled. **A3 gains an optional detection** rather than
