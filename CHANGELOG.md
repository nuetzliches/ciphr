...
Phase 0 — repository skeleton. Nothing is functional yet; the crates are empty scaffolding, and the
purpose of this phase is that the rules are in place before the code is.
