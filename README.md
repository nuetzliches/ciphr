...
> **Status: v0.13.1 released.** Usable end to end: envelope encryption with master key rotation,
...
>
> **Pin `0.13.1`, and take `ui-v0.4.1` with it.** The viewer moves separately (ADR-11), and there is
